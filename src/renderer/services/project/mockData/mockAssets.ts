...
const CHARACTER_ASSETS: AssetInfo[] = [
  ...
  createAsset(
    ...
    'character_ref',
    (() => {
      const testImage = getTestImageForCharacter('fatima-hassan');
      return testImage
        ? resolveTestAssetPath('image', testImage)
...
const SCENE_VIDEO_ASSETS: AssetInfo[] = [
  ...
  createAsset(
    ...
    'scene_video',
    (() => {
      const testVideo = getTestVideoForScene(1, 1);
  ...
  createAsset(
    ...
    'scene_video',
    (() => {
      const testVideo = getTestVideoForScene(3, 1);
      return resolveTestAssetPath('video', testVideo);
    })(),
    1,
  ...
  createAsset(
    ...
    'scene_video',
    (() => {
      const testVideo = getTestVideoForScene(3, 2);
      return resolveTestAssetPath('video', testVideo);
    })(),
    2,
