...
export {
  ...
  createImportedClip,
  synthesizeTracksFromImportedClips,
  deriveImportedClipsFromTracks,
...
export const PROJECT_PATHS = {
  ...
  ASSETS_DIR: '.kshana/assets',
  ASSETS_VIDEOS: '.kshana/assets/videos',
  ASSETS_IMAGES: '.kshana/assets/images',
  ASSETS_AUDIO: '.kshana/assets/audio',
  ASSETS_CACHE: '.kshana/assets/.cache',
  ASSETS_CACHE_THUMBNAILS: '.kshana/assets/.cache/thumbnails',
  ASSETS_CACHE_WAVEFORMS: '.kshana/assets/.cache/waveforms',
  UI_DIR: '.kshana/ui',
